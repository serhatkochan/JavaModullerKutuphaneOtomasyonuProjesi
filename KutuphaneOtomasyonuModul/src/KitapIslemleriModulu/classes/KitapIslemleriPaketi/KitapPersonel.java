...
public class KitapPersonel implements IKitapPersonel{
    ...
    @Override
    public ResultSet ara(int personelID) {  // arama
        DBAraKatmani dBAraKatmani = new DBAraKatmani();
        Connection connection = dBAraKatmani.baglan();
    ...
    @Override
    public void silme() {  // silme // iade etme
        DBAraKatmani dBAraKatmani = new DBAraKatmani();
        Connection connection = dBAraKatmani.baglan();
    ...
    public void silme(int personelID) {  // silme overloaing
        DBAraKatmani dBAraKatmani = new DBAraKatmani();
        Connection connection = dBAraKatmani.baglan();

        try {
            Statement stmt = connection.createStatement();
            stmt.executeUpdate("DELETE from tbl_odunc WHERE personel_id='"+personelID+"'");
        } catch (Exception e) {
            System.out.println(e);
        }
        dBAraKatmani.baglantiKes();
    ...
    public void silme(int kitapID, boolean kitapSilme) {  // silme overloaing boolean
        DBAraKatmani dBAraKatmani = new DBAraKatmani();
        Connection connection = dBAraKatmani.baglan();

        try {
            Statement stmt = connection.createStatement();
            stmt.executeUpdate("DELETE from tbl_odunc WHERE kitap_id='"+kitapID+"'");
        } catch (Exception e) {
            System.out.println(e);
        }
        dBAraKatmani.baglantiKes();
