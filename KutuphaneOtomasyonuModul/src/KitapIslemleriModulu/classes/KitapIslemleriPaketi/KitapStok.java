...
public class KitapStok implements IKitapStok{
    ...
    private static int kutuphaneKitapKapasitesi = 0; // Private Static Değişken
    ...
    public static boolean kutuphaneKapasitesiKontrol(){ // Static Method
        ...
        kutuphaneKitapKapasitesi = KitapStok.getKutuphaneKitapKapasitesi();
    ...
    @Override
    public void ekleme(String isim, String yazar, String yayinevi, String konu, int adet, int sayfaSayisi) {  // kitap ekleme
        DBAraKatmani dBAraKatmani = new DBAraKatmani();
        Connection connection = dBAraKatmani.baglan();
    ...
    @Override
    public ResultSet listeleme() {  // kitap listeleme
        DBAraKatmani dBAraKatmani = new DBAraKatmani();
        Connection connection = dBAraKatmani.baglan();
    ...
    @Override
    public ResultSet ara(String kitapAdi) {  // kitap arama
